...
> Note: Insert Sort is referred to as quadratic because the number of steps in the algorithm increases as a quadratic function of the size of the list.
...
Your turn! Implement Insert Sort to sort an array of integers. Log each swap after it occurs to better see how Insert Sort reorders the elements.  Use the starter code provided to get started:
